...
// These bits, though undocumented, will force VNTC to be on all the time,
// instead of just when the PMIC needs it to be on.  Communicated via
// QuantumX, see https://quantumxsupport.atlassian.net/browse/GAM-40
#define S2MU106_REG_RESET_VNTC_ON	0x0c
#define S2MU106_REG_RESET_VNTC_OFF	0x04
#define S2MU106_REG_RESET_VNTC_MASK	0x0c
