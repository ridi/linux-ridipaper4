...
static int cfg80211_wext_siwessid(struct net_device *dev,
				  struct iw_request_info *info,
				  union iwreq_data *req_data, char *ssid)
{
	struct iw_point *data = (struct iw_point *)req_data;
#else
static int cfg80211_wext_siwessid(struct net_device *dev,
				  struct iw_request_info *info,
...
#ifdef CONFIG_CFG80211_SLSI_WLAN
    DEFINE_WEXT_COMPAT_STUB(cfg80211_wext_siwessid, union iwreq_data)
#else
