...
static const char * const power_supply_type_text[] = {
	...
	"Prepare_TA", "SMART_NOTG", "WCIN", "END"
};
...
static const char * const power_supply_health_text[] = {
	"Unknown", "Good", "Overheat", "Overheat limit", "Dead",
	"Over voltage", "Unspecified failure", "Cold", "Cold limit",
	"Watchdog timer expire", "Safety timer expire", "Under voltage"
};
...
static ssize_t power_supply_show_property(struct device *dev,
	...
	if (off == POWER_SUPPLY_PROP_STATUS)
		nwritten = snprintf(buf, PAGE_SIZE, "%s\n",
		...
		nwritten = snprintf(buf, PAGE_SIZE, "%lld\n", value.int64val);
	else
		nwritten = snprintf(buf, PAGE_SIZE, "%d\n", value.intval);
